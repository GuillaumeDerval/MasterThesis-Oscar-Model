 ...
 * a < b
 */
case class Lr(a: IntExpression, b: IntExpression) extends BoolExpression {
  /**
   ...
   */
  override def mapSubexpressions(func: (IntExpression) => IntExpression): IntExpression = new Lr(func(a), func(b))
}