...
class Maximisation(val objective: IntVar) extends OptimisationMethod
class Minimisation(val objective: IntVar) extends OptimisationMethod
class NoOptimisation extends  OptimisationMethod
