 ...
 * a == b
 */
case class Eq(a: IntExpression, b: IntExpression) extends BoolExpression {
  /**
   ...
   */
  override def mapSubexpressions(func: (IntExpression) => IntExpression): IntExpression = new Eq(func(a), func(b))
}