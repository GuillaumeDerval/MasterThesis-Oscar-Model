 ...
 * a <= b
 */
case class LrEq(a: IntExpression, b: IntExpression) extends BoolExpression {
  /**
   ...
   */
  override def mapSubexpressions(func: (IntExpression) => IntExpression): IntExpression = new LrEq(func(a), func(b))
}