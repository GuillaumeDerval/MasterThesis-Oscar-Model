 ...
 * a >= b
 */
case class GrEq(a: IntExpression, b: IntExpression) extends BoolExpression {
  /**
   ...
   */
  override def mapSubexpressions(func: (IntExpression) => IntExpression): IntExpression = new GrEq(func(a), func(b))
}